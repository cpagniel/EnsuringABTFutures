%% plot_time_in_mesopelagic_map_all_ABT.m
% Sub-function of ABT.m; plots median time in mesopelagic in
% 1 x 1 degree bins.
%
...
[binned.mz,binned.LONmid,binned.LATmid] = twodmed(SSM.lon,SSM.lat,SSM.TimeinMeso,...
    binned.LONedges,binned.LATedges);
bins.all.time_in_meso = binned.mz.';
...
cd([fdir '/figures']);
exportgraphics(gcf,'time_in_mesopelagic_map_ABT.png','Resolution',300)
