%% plot_daily_dive_frequency_map_all_ABT.m
% Sub-function of ABT.m; plots median daily dive frequency in
% 1 x 1 degree bins.
%
...
[binned.mz,binned.LONmid,binned.LATmid] = twodmed(SSM.lon,SSM.lat,SSM.DivesPerDay,...
    binned.LONedges,binned.LATedges);
bins.all.daily_dive_f = binned.mz.';
...
colormap(getPyPlot_cMap('YlGnBu',10));
...
cd([fdir '/figures']);
exportgraphics(gcf,'daily_dive_frequency_map_ABT.png','Resolution',300)
