%% plot_dive_duration_map_all_ABT.m
% Sub-function of ABT.m; plots median dive duration in
% 1 x 1 degree bins.
%
...
cd([fdir '/figures']);
exportgraphics(gcf,'dive_duration_map_ABT.png','Resolution',300)
