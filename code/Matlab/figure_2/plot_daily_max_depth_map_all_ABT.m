%% plot_daily_max_depth_map_all_ABT.m
% Sub-function of ABT.m; plots median daily maximum dive depth in
% 1 x 1 degree bins.
%
...
[binned.mz,binned.LONmid,binned.LATmid] = twodmed(SSM.lon,SSM.lat,SSM.MaxDepth,...
    binned.LONedges,binned.LATedges);
bins.all.daily_max_d = binned.mz.';
...
cd([fdir '/figures']);
exportgraphics(gcf,'daily_max_depth_map_ABT.png','Resolution',300)
