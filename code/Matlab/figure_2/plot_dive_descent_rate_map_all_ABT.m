%% plot_dive_descent_rate_map_all_ABT.m
% Sub-function of ABT.m; plots median dive max descent rate in
% 1 x 1 degree bins.
%
...
bins.all.descent_rate = binned.mz.';
...
cd([fdir '/figures']);
exportgraphics(gcf,'dive_descent_rate_map_ABT.png','Resolution',300)
